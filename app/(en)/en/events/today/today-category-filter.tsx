...
export const TodayCategoryFilter = ({ groups }: Props) => {
  ...
  if (groups.length === 0) {
    return <p className="events-page__empty">No events to display by category.</p>
  }
  ...
  return (
    <>
      <div className="today-venue-filter">
        <p className="today-venue-filter__label">Filter by category</p>
