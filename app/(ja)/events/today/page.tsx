...
const FAQ_ITEMS = [
  ...
  {
    q: "今日のアニメイベントは秋葉原でどこで見られますか？",
    a: "ページ内「カテゴリ別イベント」の「アニメ・漫画」タブから、今日のアニメイベントだけを絞り込んで確認できます。開催中のアニメ・漫画関連イベントを会場・期間・公式リンク付きで一覧表示します。",
  },
  {
...
export const generateMetadata = () => {
  ...
  const title = `今日のアニメイベント【秋葉原${dateLabel}開催中${ongoingCount}件】ゲーム・ポップアップも一覧`
  const description = `今日のアニメ関連イベントを含む、${dateLabel}に今日行ける秋葉原イベントを一覧で紹介。アニメ・漫画、ゲーム・トレカ、コラボカフェ、ポップアップストア、声優・アイドル、ホビー・フィギュアなど${ongoingCount}件を会場・期間・公式リンク付きで確認できます。AKIHABARAゲーマーズ・書泉ブックタワー・アトレ秋葉原など主要会場別にも絞り込み可能。`
  return {
    title,
    description,
...
const Page = () => {
  ...
  const collectionPageJsonLd = {
    ...
    "@id": pageUrl,
    url: pageUrl,
    name: "今日のアニメイベント【秋葉原で今日開催】",
    description:
      "今日のアニメイベントを中心に、秋葉原で今日開催中のイベントを一覧で紹介。アニメ、ゲーム、コラボカフェ、POPUP、ホビー、PC関連イベントを開催場所・期間・公式リンク付きで確認できます。",
    dateModified: today,
    inLanguage: "ja",
