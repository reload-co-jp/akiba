  ...
  return (
    ...
    >
      ...
      >
        ...
        <ul>
          <li>
            アクセス日時・閲覧ページ・参照元URL・ブラウザ情報・IPアドレスなどのアクセスログ
          </li>
          <li>Cookieおよびこれに類する技術を通じた識別情報</li>
        </ul>
        <p>
          氏名・メールアドレスなどの個人を直接特定できる情報は収集していません。
        </p>
      </section>
      ...
      >
        ...
        <p>
          本サービスはアクセス解析のためGoogle Analytics（Google
          LLC）を使用しています。Google
          AnalyticsはCookieを使用してアクセス情報を収集します。収集されたデータはGoogleのプライバシーポリシーに基づいて管理されます。
        </p>
        <p>
      ...
      <section className="about-section" aria-labelledby="privacy-ads-title">
        ...
        <p>
          本サービスはGoogle AdSense（Google
          LLC）による広告を掲載しています。Google
          AdSenseはCookieを使用して、ユーザーの興味に基づいた広告を表示します。
        </p>
        <p>
      ...
      <section className="about-section" aria-labelledby="privacy-swg-title">
        ...
        <p>
          本サービスはGoogleのReader Revenue Manager（Subscribe with
          Google）を利用しています。これによりGoogleはCookieを使用して本サービスの閲覧状況を把握する場合があります。詳細はGoogleのプライバシーポリシーをご確認ください。
        </p>
      </section>
