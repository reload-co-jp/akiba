...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: absoluteUrl("/events/collab-cafe/"), lastModified: latestDate, changeFrequency: "daily", priority: 0.8 },
    { url: absoluteUrl("/events/popup/"), lastModified: latestDate, changeFrequency: "daily", priority: 0.8 },
