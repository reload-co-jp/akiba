...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: absoluteUrl("/events/calendar/"), lastModified: latestDate, changeFrequency: "daily", priority: 0.7 },
    { url: absoluteUrl("/en/events/"), lastModified: latestDate, changeFrequency: "daily", priority: 0.6 },
    { url: absoluteUrl("/en/events/today/"), lastModified: latestDate, changeFrequency: "daily", priority: 0.7 },
    { url: absoluteUrl("/en/events/this-week/"), lastModified: latestDate, changeFrequency: "daily", priority: 0.6 },
    { url: absoluteUrl("/en/events/monthly/"), lastModified: latestDate, changeFrequency: "weekly", priority: 0.6 },
    { url: absoluteUrl("/en/events/collab-cafe/"), lastModified: latestDate, changeFrequency: "daily", priority: 0.6 },
    { url: absoluteUrl("/en/events/popup/"), lastModified: latestDate, changeFrequency: "daily", priority: 0.6 },
